...
> This completed roadmap documents the `mean-depth-wave-generator` implementation retained on the `terrain-energy-galerkin` branch as a validated baseline. The active development roadmap is [milestones.md](milestones.md).
